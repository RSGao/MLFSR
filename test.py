...
from train import test, test_whole
    ...
    with torch.no_grad():
        ...
        for index, test_name in enumerate(test_Names):
            ...
            if args.test_mode == 'whole':
                psnr_iter_test, ssim_iter_test, LF_name, viewPSNR = test_whole(test_loader, device, net, save_dir)
            else:
                psnr_iter_test, ssim_iter_test, LF_name, viewPSNR = test(test_loader, device, net, save_dir)
