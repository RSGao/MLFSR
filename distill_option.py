...
parser.add_argument('--model_name', type=str, default='MLFSR', help="model name")
...
parser.add_argument('--path_for_train', type=str, default='./data_for_training32-128_stride32/')
parser.add_argument('--path_for_test', type=str, default='./data_for_test/') 
parser.add_argument('--path_log', type=str, default='./log/')
parser.add_argument('--tbpath', type=str, default='./tblog/')
...
parser.add_argument('--epoch', default=100, type=int, help='Epoch to run [default: 50]')
